...
MODEL_PATH = "/home/tomi/code/dipl/growing/techniques_experiment/grown_models/GradMax-gradient.pt"
DATA_DIR   = "/home/tomi/code/dipl/datasets/mini_set/sub10k_open_images_v7/images/test"
INPUT_SIZE = 640
CODE_DIRS  = ["/home/tomi/code/dipl/custom_models/student_2_m"]
N_IMAGES   = 10
DEVICE     = "cuda"
...
def _selfcheck():
    ...
    ep = tmp / "tiny_eager.pt"; torch.save(m, str(ep))
