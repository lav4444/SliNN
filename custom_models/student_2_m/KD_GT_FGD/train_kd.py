...
# baseline_models/yolo26l/reduce_p3_to_pca.py). For 2M student (P3 channels = 96),
# FGD adds a small 96 → 48 projection — much smaller than the original 96 → 512.
FGD_TEACHER_CH = 48     # PCA-reduced teacher P3 channels (top-48 components)
FGD_STUDENT_CH = 96     # student_2_m dark3 output channels
...
class FGDFeatureLoss(nn.Module):
    ...
    This avoids the rank-bottleneck issue from the original FGD design where a 96→512
