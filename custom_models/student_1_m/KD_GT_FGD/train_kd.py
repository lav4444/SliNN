...
# baseline_models/yolo26l/reduce_p3_to_pca.py). For 1M student (P3 channels = 64),
# FGD adds a small 64 → 48 projection — much smaller than the original 48 → 512.
FGD_TEACHER_CH = 48     # PCA-reduced teacher P3 channels (top-48 components)
FGD_STUDENT_CH = 64     # student_1_m dark3 output channels
