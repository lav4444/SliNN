"""
summary_20k.py -- provjera da su svi 20k runovi zavrsili i zbirna tablica
KD_featlogit part1 vs 20k. Validacija/eval su na part1 splitovima u oba slucaja.
"""
...
def eval_maps(f: Path) -> dict:
    """-> {'TRAIN': x, 'VAL': y, 'TEST': z} iz eval_result.txt"""
    if not f.exists():
        return {}
    txt = f.read_text()
    out = {}
