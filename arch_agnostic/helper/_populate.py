"""_populate.py — FAZA 3: populacija LAYER_REGISTER.json preko cijelog zoo-a.

Za svaki model: probe -> classify -> capabilities_by_type (STVARNI prune/grow pokusaj kroz morphology,
deepcopy-izoliran) -> merge_register (aditivno, OR, hazardi zasticeni). OR preko zooa sam ispravlja
lazne negative (ista TIP-zastavica se skupi iz bilo kojeg modela gdje uspije).

Rezultat -> arch_agnostic/register_report.txt (+ ispis). Registar se BACKUPira prije pokretanja (rucno).
"""
import os
import sys
